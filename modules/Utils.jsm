...
var Utils =
{
  ...
  get addonID()
  {
    return "abprime@projects.binaryoutcast.com";
  },
  ...
  get appLocale()
  {
    ...
    try
    {
      locale = Utils.chromeRegistry.getSelectedLocale("abprime");
    }
    catch (e)
    {
      Cu.reportError(e);
  ...
  {
    let stringBundle = Services.strings.createBundle("chrome://abprime/locale/global.properties");
  ...
  openFiltersDialog: function(filter)
  {
    ...
    {
      Utils.windowWatcher.openWindow(null, "chrome://abprime/content/filters.xul", "_blank", "chrome,centerscreen,resizable,dialog=no", {wrappedJSObject: filter});
    }
  },
